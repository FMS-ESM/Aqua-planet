...
!---- version number -----
  character(len=128) :: version = '$Id: nh_core.F90,v 17.0.4.3 2011/08/22 18:33:37 Peter.Phillipps Exp $'
...
contains
  ...
  subroutine update_dz_d(ndif, damp, hord, is, ie, js, je, km, ng, npx, npy, area, zs, zh, crx, cry, xfx, yfx, delz, ws, rdt, id_ws)
  ...
  subroutine Riem_Solver(dt, is, ie, js, je, km, ng, akap, cp, ptop, hs, w, delz, pt, delp, gz, pkc, pk, pe, peln, da_min, diff_z0, first_call, last_call, compute_pvar)
